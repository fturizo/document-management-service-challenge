...
/**
 * Exception thrown when attempting to create or upload a document that already exists in the system.
 * <br>
 * This runtime exception is typically used in scenarios where a document with the specified name
 * conflicts with an existing document. It provides a message detailing the name of the conflicting document.
 * <br>
